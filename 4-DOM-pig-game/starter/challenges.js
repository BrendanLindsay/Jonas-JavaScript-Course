...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if (gamePlaying) {
        ...
        if (dice === 6 && lastDice === 6) {
            //Player loses score, as they rolled two sixes in a row
       ...
       //Coding challenge part 3: two dice
       if (dice1 !== 1 && dice2 !== 1) {
        //Add score
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    if(gamePlaying) {
        ...
        //Coding challenge: detect if there's a value in "Final Score" box
        //If yes, assign that number to winningScore
        //If not, default is 100
